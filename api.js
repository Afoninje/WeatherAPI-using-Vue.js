  ...
  methods: {
    process: function () {
      ...
      axios.get(url).then(function (res) {
        ...
        vm.findcountry = res.data.sys.country;
        vm.findlocation = res.data.name;
        vm.findwind = res.data.wind.speed;
    ...
    showPosition: function (position) {
      ...
      axios
        ...
        .then(function (res2) {
          ...
          vm.usercountry = res2.data.sys.country;
          vm.userlocation = res2.data.name;
          vm.userwind = res2.data.wind.speed;
          vm.usertemp = res2.data.main.temp;
